...
from shelfscan.auth import create_access_token, hash_password, verify_password
from shelfscan.database import get_session
from shelfscan.email import notify_admin_new_registration
from shelfscan.isbn_lookup import lookup_isbn
from shelfscan.models import Book, BookCopy, Shelf, User, UserStatus
...
def _templates(request: Request):
    from shelfscan.app import templates
